...
<%
	...
	String identityid					= formatString(callbackResult.get("identityid"));
	String identitytype					= formatString(callbackResult.get("identitytype"));
...
<title>一键支付-通知回调</title>
	...
	<body>
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" 
			...
			<tr>
				<td width="25%" align="left">&nbsp;身份标识</td>
				<td width="5%"  align="center"> : </td> 
			...
			<tr>
				<td width="25%" align="left">&nbsp;身份类型</td>
				<td width="5%"  align="center"> : </td> 
