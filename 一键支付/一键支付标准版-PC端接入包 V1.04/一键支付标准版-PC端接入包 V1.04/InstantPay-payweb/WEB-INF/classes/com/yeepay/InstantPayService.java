...
public class InstantPayService {
	...
	/**
	 * getPaywebRequestURL() : 返回移动端网页支付链接
	 *
	 * 参数说明：
	 *
	 ...
	 * callbackurl         	- string	- 必填		- 后台回调地址
	 * terminalid          	- string	- 非必填	- 终端标识ID
	 * terminaltype        	- int		- 非必填	- 终端标识类型
	...
	public static String getPaywebRequestURL(Map<String, String> params) {
		...
		System.out.println("##### getPaywebRequestURL() #####");
	 ...
	 *
	 * 参数说明：所有的请求参数名，均是大小写敏感的，如：merchantaccount，为小写无大写。
	 *
	 * merchantaccount		- 商户编号
	 * merchantPrivateKey	- 商户私钥
	 * merchantAESKey		- 商户随机生成的AESKey
	 ...
	 *
	 * data					- 易宝返回的加密数据
	 * encryptkey			- 易宝返回的encryptkey
	 *
	 * customError          - string	- 为自定义参数，非接口返回。
	 */
